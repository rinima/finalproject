				...
				<div class="cztable">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<th style="text-align: left;" width="5%">容量</th>
							<th style="text-align: left;" width="5%">修改课程</th>
							<th style="text-align: left;" width="5%">删除课程</th>
						...
						<tr>
							...
							<td><center></center><s:property value="seat"/></td>
							<td><center><a href="details.jsp?sectionNo=<s:property value='sectionNo'/>&ssn=<s:property value='ssn'/>">编辑</a></center></td>
							<td><center><a href="delCourse?sectionNo=<s:property value='sectionNo'/>">删除</a></center></td>
