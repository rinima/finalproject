				...
				<div class="cztable">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<th style="text-align: left;" width="5%">学分</th>
							<th style="text-align: left;" width="10%">先修课程</th>
						...
						<tr>
							...
							<td><center><s:property value="credits"/></center></td>
							<td><center><s:property value="prerequisites"/></center></td>
