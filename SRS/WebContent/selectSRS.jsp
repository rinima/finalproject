			...
			<div class="page">
				...
				<div class="blog_nav">
				 <ul>
                        <li><a href="#">个人信息</a></li>
                        <li><a href="#">学习计划</a></li>
                        <li><a href="total.do?action=search">查看成绩</a></li>
                        <li><a href="date.jsp">选课系统</a></li>
                        <li><a href="#">返回首页</a></li>
                    </ul>
				</div>
			</div>
                ...
                <div class="l_nav2">
                    ...
                    <div class="cdlist">
                        ...
                        <div>
                    		...
                    		<a href="manageuser.jsp">学习计划</a>
</div>
                        <div>
                           <a href="password.jsp">查看成绩</a></div>
...
<div class="cdlist">
			...
			<div class="rightbox">
				...
				<h2 class="mbx">选课系统 </h2>

				<div class="cztable">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<th style="text-align: left;" width="5%">班次号</th>
							<th style="text-align: left;" width="10%">时间</th>
							<th style="text-align: left;" width="5%">所属课程</th>
							<th style="text-align: left;" width="5%">教室</th>
							<th style="text-align: left;" width="5%">学期</th>
							<th style="text-align: left;" width="5%">教师</th>
							<th style="text-align: left;" width="5%">选课</th>
						...
						<tr>
							...
							<td><center><s:property value="room"/></center></td>
							<td><center><s:property value="semester"/></center></td>
							<td><center></center><s:property value="professor"/></td>
							<td><center></center><s:property value="courseNo"/></td>
